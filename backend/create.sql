...
alter table if exists tb_record add constraint FKk5bmm1a76ij93i60umu7syojv foreign key (game_id) references tb_game;INSERT INTO tb_genre (name) VALUES ('Shooter');
